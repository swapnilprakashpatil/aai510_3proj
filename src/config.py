...
# Model directories
SUPERVISED_MODEL_DIR = os.path.join(BASE_DIR, 'models', 'supervised')
UNSUPERVISED_MODEL_DIR = os.path.join(BASE_DIR, 'models', 'unsupervised')
...
# Emotion variations for sentiment analysis
EMOTION_VARIATIONS = {
...
# Negation patterns for sentiment analysis
NEGATION_PATTERNS = [
